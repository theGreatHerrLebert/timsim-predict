...
def predict_rt_index(
    ...
    :mod:`timsim_predict._models`): ``None`` for our default (Chronologer), or
    ...
    if kind == "koina":
        ...
        from pepdl.rt.predictors import load_deep_retention_time_predictor
...
def main(argv=None) -> int:
    ...
    ap.add_argument("--model", default=None,
                    help="RT model spec: omit for our default (Chronologer), or 'koina:<name>' for "
                         "a Koina model. See timsim_predict._models.")
